...
import { Classes, H5, HTMLSelect, Label, Switch } from "@blueprint-modernized/core";
import { DateRange, DateRangePicker, TimePrecision } from "@blueprint-modernized/datetime";
import {
    Example,
    handleBooleanChange,
    handleNumberChange,
