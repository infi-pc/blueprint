...
import { Callout, Code, H5, Intent, Switch } from "@blueprint-modernized/core";
import { Example, handleBooleanChange, handleValueChange, IDocsExampleProps } from "@blueprint-modernized/docs-theme";
