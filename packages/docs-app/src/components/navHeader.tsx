...
import { Classes, HotkeysTarget2, Intent, Menu, MenuItem, NavbarHeading, Tag } from "@blueprint-modernized/core";
import { NavButton } from "@blueprint-modernized/docs-theme";
