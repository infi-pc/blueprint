...
/**
 * Enable @blueprint-modernized/eslint-plugin.
 * For TS files, configure typescript-eslint, including type-aware lint rules which use the TS program.
 */
module.exports = {
    plugins: ["@blueprint-modernized", "header", "import", "jsdoc", "react"],
    extends: ["plugin:@blueprint-modernized/recommended", "plugin:import/typescript"],
    parserOptions: { ecmaVersion: 2017 },
    settings: {
        "import/internal-regex": "^@blueprint-modernized",
    },
    rules: {
        // HACKHACK: this rule impl has too many false positives
        "@blueprint-modernized/classes-constants": "off",
        ...eslintBuiltinRules,
        ...eslintPluginRules,
    },
    overrides: [
