...
Tooltip2 component available in the `@blueprint-modernized/popover2` package. You should migrate
...
```tsx
import { Button, Popover, Position, Tooltip } from "@blueprint-modernized/core";
